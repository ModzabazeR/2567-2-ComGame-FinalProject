...
public class MainScene : Game
{
    ...
    protected override void LoadContent()
    {
        ...
        // Initialize Spine Renderer
        skeletonRenderer = new SkeletonRenderer(GraphicsDevice);
        skeletonRenderer.PremultipliedAlpha = true;

        // Load Spine Atlas and Skeleton Data
        atlas = new Atlas("Content/Player.atlas", new XnaTextureLoader(GraphicsDevice));
        SkeletonJson json = new SkeletonJson(atlas);
        skeletonData = json.ReadSkeletonData("Content/Player.json");
        ...
        player = new Player(skeleton, animationState, new Vector2(50, 700), GraphicsDevice);
